                    ...
                    <div class="view-mail-list sm-res-mg-t-30">
                        <div class="view-mail-atn">
                            <div class="ongfg-email" style="margin: 1rem; padding: .5rem 1rem; border: 3px solid rgb(0, 255, 0); border-radius: 1rem; box-shadow: .9px .2px 2px 2px blue;">
                                <h3 class="ongfg-h3" style="font-family:'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-weight: normal; ">Bonjour Madame/Monsieur <span class="ongfg-user" style="font-weight: bolder;"> ${" "+data.nomExpediteur+" "+data.prenomExpediteur},</span></h3>
                                <div class="ongfg-div1" style="margin: .5rem 0; font-size: larger; font-family:system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">Vous avez effectué un virement de <strong>${data.montant} FCFA</strong> vers le <strong>${data.beneficiaire}</strong>  compte de <strong> Madame/Monsieur ${" "+data.nomBeneficiaire+" "+data.prenomBeneficiaire}</strong> à la date du <strong>${data.dateVirement}</strong>. </div>
...
module.exports = rapport_transation;